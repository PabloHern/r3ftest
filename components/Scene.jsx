...
Files: scene.gltf [152.08KB] > scene-transformed.glb [4.45MB] (-2827%)
...
export function Porsche(props) {
  const { nodes, materials } = useGLTF('/models/porsche/scene-transformed.glb')
  return (
...
useGLTF.preload('/models/porsche/scene-transformed.glb')
